  ...
  return (
    <div className="flex justify-center items-center h-screen p-10">
      <div className="flex w-[950px] h-[720px] bg-white/10 backdrop-blur-md border border-white/20 shadow-lg rounded-3xl p-5">
        ...
        <div className="w-[400px] h-[300px] bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl shadow-md rounded-2xl mb-3 p-5">
          <img 
          ...
          <div className="flex flex-rows">
            <div className="w-[100px] h-[60px] bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-white/10 rounded-3xl shadow-md rounded-2xl mb-3 mr-3 flex justify-center items-center cursor-pointer ">
            ...
            <div className="w-[100px] h-[60px] bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl border border-white/10 rounded-3xl shadow-md rounded-2xl mb-3 flex justify-center items-center cursor-pointer">
